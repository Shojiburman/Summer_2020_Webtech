        ...
        <tr>
            <td width="340px" height="600px" style="background-color: #f3f5f7">
                <ul>
                    ...
                    <li>
                        <a href="comment_rating.php" style="text-decoration: none; color: white; padding: 10px 30px; border: 1.5px solid #0aab8e; border-radius: 5px; background-color: #0aab8e;">COMMENTS & RATING</a>
                    </li>
                    <li>
