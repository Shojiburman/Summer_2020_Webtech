        ...
        <tr>
            <td width="340px" height="600px" style="background-color: #f3f5f7">
                <ul>
                    ...
                    <li>
                        <a href="faqs.php" style="text-decoration: none; color: white; padding: 10px 30px; border: 1.5px solid #0aab8e; border-radius: 5px; background-color: #0aab8e;">FAQs</a>
                    </li>
                </ul>
            </td>
            <td width="800px" height="600px" style="background-color: #f3f5f7">
                <h3 style="font-family: Roboto; margin: 20px 10px 20px 10px; color: #0aab8e" align="center">FAQs</h3>                 
            </td>
        </tr>
    </table>
</body>
